...
void PrintAbsyn::visitClassExt(ClassExt *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
{
  iterListMember(listmember->begin(), listmember->end());
}

void PrintAbsyn::iterListMember(ListMember::const_iterator i, ListMember::const_iterator j)
{
  if (i == j) return;
  { /* cons */
    (*i)->accept(this); iterListMember(i+1, j);
  }
}
...
void PrintAbsyn::visitTArr(TArr *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitEPrim(EPrim *p)
{
  int oldi = _i_;
...
void ShowAbsyn::visitClassExt(ClassExt *p)
{
  bufAppend('(');
  bufAppend("ClassExt");
  bufAppend(' ');
...
void ShowAbsyn::visitTArr(TArr *p)
{
  bufAppend('(');
  bufAppend("TArr");
  bufAppend(' ');
...
void ShowAbsyn::visitEPrim(EPrim *p)
{
  bufAppend('(');
  bufAppend("EPrim");
  bufAppend(' ');
